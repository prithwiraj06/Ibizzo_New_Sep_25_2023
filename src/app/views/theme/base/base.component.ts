...
export class BaseComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.checkForMiniSite = window.location.href.includes("dashboard")
      ? false
      : window.location.href.includes("pages")
      ? false
      : window.location.href.includes("/m/p/")
      ? false
      : true;
  }
   ...
   */
  ngOnInit(): void {
    this.isRoute=window.location.href.includes('/main/pages/home')
